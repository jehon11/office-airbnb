...
office_1 = OfficeSpace.create!(name: "Prudential Plaza 10F", address: "1-6-5 Marunouchi Chiyoda-ku Tokyo 100-0005", description: "Host 8 people group meeting and jam sessions. Space has the power to unlock potential — in our teams and in ourselves. Our workspaces blend intentional design, warm hospitality, and flexibility so you and your team can do your best work.", price: 2400, owner: user1)
url = "https://i.pinimg.com/originals/88/6e/25/886e25879db8d6db6e6a8a2301d21393.jpg"
office_1.remote_photo_url = url
office_1.save


office_2 = OfficeSpace.create!(name: "6722 Alize Masion", address: "1-4-5 Roppongi Minato-ku Tokyo 106-0032", description: "The room was painted a bluish gray color from top to bottom, with a simple floral design border all of the way around. The ceiling of the room was the same color as the walls and the floor was made of dark brown stained wood paneling.", price: 60, owner: user1, )
...
office_3 = OfficeSpace.create!(name: "310 East Pine St.", address: "2-1-6 Uchisaiwaicho Chiyoda-ku Tokyo 100-0011", description: "An upgraded private office with access to premium shared spaces and amenities. Includes your own meeting rooms, lounges, and executive offices dedicated to your team", price: 80, owner: user2)
...
office_4 = OfficeSpace.create!(name: "7C Roe Ave", address: "6-10-1 Ginza Chuo-ku Tokyo 104-0061", description: "A standalone, private office in a location dedicated to your team (no shared spaces). Includes just the essentials with preconfigured layouts, and basic amenities.", price: 40, owner: user2)
...
office_5 = OfficeSpace.create!(name: "Allen Hall 014 Room", address: "1-24-3, Minami Aoyama Minato-ku Tokyo 107-0062", description: "Enclosed, lockable offices can accommodate teams of any size. Move-in ready, with desks, chairs, and filing cabinets.", price: 55, owner: user2)
...
office_6 = OfficeSpace.create!(name: "75 West Wim Blvd", address: "2 Chome-11-3 Meguro, Meguro-ku, Tōkyō-to 153-0063", description: "Choose a flexible hot desk in an open space or a permanent dedicated desk in a shared office. You’ll get access to premium amenities with a guaranteed spot to plug in and get to work.", price: 55, owner: user2)
